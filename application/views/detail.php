...
<body>
			...
			<div class="navbar-nav ms-auto py-4 py-lg-0">
				...
				<div class="nav-item dropdown">
					...
					<div class="dropdown-menu rounded-0 rounded-bottom m-0">
						...
						<a href="<?= base_url('bernda/kategori/'.$kate['id_kategori']) ?>"
							class="dropdown-item"><?= $kate['nama_kategori'] ?></a>
						<?php }?>
	...
	<div class="container py-5">
		<div class="row pt-5">
			<div class="col-lg-12">
				<div class="d-flex flex-column text-left mb-3">
					...
					<div class="d-flex">
						...
						<p class="mr-3"><i class="fa fa-comments text-primary"></i> <?= $konten->nama_kategori;?></p>
					</div>
				</div>
				<div class="mb-5">
			...
			<!-- Footer Start -->
			<div class="container-fluid bg-dark text-secondary footer mt-12 py-12 wow fadeIn" data-wow-delay="0.1s">
